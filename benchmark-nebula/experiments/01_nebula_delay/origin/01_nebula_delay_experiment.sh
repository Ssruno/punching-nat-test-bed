...
echo "seconds;size;filename;iteration" > /vagrant/experiments/01_nebula_delay/results/01_nebula_delay_1500_results.csv
...
do
    ...
    do        
        ...
        { /usr/bin/time  -f "%e; ${size_of_files[$file]}; ${name_of_files[$file]}; $iteration" scp -q /vagrant/experiments/01_nebula_delay/origin/${name_of_files[$file]} vagrant@$destination:/vagrant/experiments/01_nebula_delay/destination/ ; } 2>> /vagrant/experiments/01_nebula_delay/results/01_nebula_delay_1500_results.csv
    done
done
